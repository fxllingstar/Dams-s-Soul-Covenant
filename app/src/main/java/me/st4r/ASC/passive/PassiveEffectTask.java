...
import me.st4r.ASC.passive.effects.BraveryPassive;
import me.st4r.ASC.passive.effects.DeterminationPassive;
import me.st4r.ASC.passive.effects.IntegrityPassive;
import me.st4r.ASC.passive.effects.JusticePassive;
import me.st4r.ASC.passive.effects.KindnessPassive;
import me.st4r.ASC.passive.effects.PatiencePassive;
import me.st4r.ASC.passive.effects.PerseverancePassive;
...
public class PassiveEffectTask {
    ...
    public PassiveEffectTask(ASC plugin) {
        this.plugin = plugin;
