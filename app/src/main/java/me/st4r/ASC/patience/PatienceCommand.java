...
public class PatienceCommand implements CommandExecutor, TabCompleter {
    ...
    public PatienceCommand(ASC plugin) {
        this.plugin = plugin;
    }
    ...
    private boolean handleCreate(CommandSender sender, String label) {
        ...
        ASC.PatienceChestSeedResult seedResult = plugin.seedPatienceChestDetailed(sender instanceof Player player ? player.getUniqueId() : null);
    ...
    private String getCreateFailureMessage(ASC.PatienceChestSeedStatus status) {
